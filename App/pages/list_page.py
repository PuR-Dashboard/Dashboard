...
def create_content(df: pd.DataFrame)-> (list,list):
    """
...
@callback(
    Output("placeholder_div_edit" + seitentag, "n_clicks"),
...
def define_inputs_advanced_filter(special_ones):
...
def define_outputs_advanced_filter(special_ones:list):
...
def define_inputs_add_location(special_ones:list):
...
def define_outputs_add_loction(special_ones:list):
...
@callback(
    ...
    Input("placeholder_div_edit"+seitentag, 'n_clicks'),
...
def update_layout(*args):
    ...
    if triggered_id == "clear_filter_button" + seitentag:
        ...
        return (refresh_layout(),) + tuple(sidebar_values)
    elif triggered_id == "placeholder_div_filter" + seitentag or triggered_id == "placeholder_div_adding" + seitentag or triggered_id == "placeholder_div_delete_list" or triggered_id ==  "placeholder_div_edit"+ seitentag:
        return (refresh_layout(),) + tuple(sidebar_values)
    else:
        #print("im in")
        reset_data()
