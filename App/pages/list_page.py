            ...
            [
                html.Div(
                    children=[
                        ...
                        dbc.Col(dbc.CardImg(src= get_image(names[i]), #if you want to present a picture on the listpage, just add a path to the picture by extracting it out of the excel-file
